...
<div class="content">
    <div class="products-content-games products-content__sidebar">
        <div class="all-content-wrapp"></div>
        <div class="content-text">
            <h1 class="title-pgb-simple">Latest Reviews</h1>
            <ul>
                <?php 
                    echo do_shortcode('[ajax_products]'); 
                ?>
            </ul> 
        </div>
        <div class="pgb-sidebar blue-lines">
            ...
            <div class="sidebar-content">
                ...
                <section class="sidebar-last-reviews">
                    <h2 class="title-sidebar">VR Reviews</h2>
                    <ul class="">
                        <?php 
                            $args = array(
                                'posts_per_page' => '5',
...
<script src="<?php bloginfo('template_url'); ?>/js/templates/page-index.js"></script>