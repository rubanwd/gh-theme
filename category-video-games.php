        ...
        <div class="content">
            ...
            <div class="products-content-games products-content__sidebar">
                ...
                <div class="content-text">
                    <h1 class="title-pgb-simple">Games <span>Review</span></h1>
                    <ul>
                        <?php 
                                echo do_shortcode('[ajax_games]'); 
                            ?>
                    </ul> 
                </div>
                <div class="pgb-sidebar">
...
<script src="<?php bloginfo('template_url'); ?>/js/templates/category-video-games.js"></script>