        ...
        <div class="product-single-title">
            ...
            <div class="single-product-content" id="spg">
                ...
                <div class="product-image-wrapp">
                    ...
                    <img class="product-image-shadow-mobile" src="<?php bloginfo('template_url'); ?>/img/shadow-btn.png" alt=""> -->
                </div>
                ...
                <div class="single-product-content__text">
                    ...
                    <div class="comments-action">
                        <h4>Have you already used the "<?php the_title() ?>" ? Tell us about your impressions and successes in comments <br> ↓↓↓</h4>
                    </div>
...
<script src="<?php bloginfo('template_url'); ?>/js/templates/single-products-hardware.js"></script>