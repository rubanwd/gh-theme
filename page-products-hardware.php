<?php
/*
Template Name: Product Hardware
        ...
        <div class="content">
            ...
            <div class="products-content-games products-content__sidebar">
                ...
                <div class="content-text">
                    <h1 class="title-pgb-simple">Hardware Review</h1>
                    <ul>
                        <?php 
                                echo do_shortcode('[ajax_hardware]'); 
                            ?>
                    </ul> 
                </div>
...
<?php get_footer(); ?>  
<script src="<?php bloginfo('template_url'); ?>/js/templates/page-products-hardware.js"></script>